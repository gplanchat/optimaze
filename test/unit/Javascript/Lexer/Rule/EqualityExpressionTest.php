    ...
    extends AbstractRuleTest
{
    ...
    public function testOneCondition($operatorType, $operatorValue)
    {
        ...
        $ruleServices = [
            ['RelationalExpression', new Rule\TokenSeekerIterator([
        ...
        $root->expects($this->at(0))
            ->method('addChild')
            ->with($this->isInstanceOf(Grammar\EqualityExpression::class))
        ;

        $rule = new EqualityExpression($this->getRuleServiceManagerMock($ruleServices),
    ...
    public function testPassThrough()
    {
        ...
        $ruleServices = [
            ['RelationalExpression', new Rule\TokenSeeker(TokenizerInterface::TOKEN_IDENTIFIER, 'a', true)],
        ];
